...
<div class="container">
    <div class="card card-create-book shadow">
        <div class="card-header card-header-create-book">
        ...
        <div class="card-body">
            <form action="{{ route('books.store') }}" method="POST" autocomplete="off">
                ...
                <div class="form-floating mb-4">
                    <input type="number" name="pages" id="bookPages" value="{{ old('pages') }}"
