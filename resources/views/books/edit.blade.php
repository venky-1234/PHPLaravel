...
<div class="container">
    <div class="card card-edit-book shadow">
        <div class="card-header card-header-edit-book">
            <i class="bi bi-journal-check"></i> Edit Book
        </div>
        <div class="card-body">
            <form action="{{ route('books.update', $book) }}" method="POST" autocomplete="off">
                ...
                <div class="form-floating mb-4">
                    ...
                    <label for="bookTitle"><i class="bi bi-book"></i> Title</label>
                    @error('title') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="form-floating mb-4">
                    <input type="number" name="pages" id="bookPages" value="{{ old('pages', $book->pages) }}"
                        class="form-control" placeholder="Pages" required>
                    <label for="bookPages"><i class="bi bi-file-earmark-text"></i> Pages</label>
                    @error('pages') <small class="text-danger">{{ $message }}</small> @enderror
                </div>
                <div class="form-floating mb-4">
                    <select name="author_id" id="bookAuthor" class="form-select" required>
                    ...
                    <label for="bookAuthor"><i class="bi bi-person"></i> Author</label>
