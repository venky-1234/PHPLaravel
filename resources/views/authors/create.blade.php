...
<div class="container">
    <div class="card card-create-author shadow">
        <div class="card-header card-header-create-author">
            <i class="bi bi-person-plus-fill"></i> Create Author
        </div>
        <div class="card-body">
            <form action="{{ route('authors.store') }}" method="POST" autocomplete="off">
                ...
                <div class="form-floating mb-4">
                    <input type="text" name="name" class="form-control" id="authorName"
                        value="{{ old('name') }}" placeholder="Author Name" required>
